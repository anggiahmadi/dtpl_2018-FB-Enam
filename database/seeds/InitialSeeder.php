...
<<<<<<< HEAD
        ...
        DB::table('packages')->insert([
            'id' => 1, 'code' => 'P001', 'name' => 'Paket Rekreasi Jakarta', 'default_picture' => 'images/paket_rekreasi_jakarta.jpg', 'desc' => 'Dunia Fantasi adalah salah satu tempat rekresi yang tepat untuk wahana bermain dan berkumpul bersama keluarga atau teman.', 'location' => 'Jakarta', 'price' => '300000'
        ]);
        DB::table('packages')->insert([
            'id' => 2, 'code' => 'P002', 'name' => 'Paket Wisata Lembang', 'default_picture' => 'images/paket_wisata_lembang.jpg', 'desc' => 'Lembang merupakan objek wisata dimana kamu bisa belajar sejarah di tengah-tengah modernisasi Kota Jakarta.', 'location' => 'Bandung', 'price' => '500000'
        ]);
        DB::table('packages')->insert([
            'id' => 3, 'code' => 'P003', 'name' => 'Paket Kepulauan Seribu', 'default_picture' => 'images/paket_kepulauan_seribu.jpg', 'desc' => 'Kepulauan seribu merupakan objek wisata dimana kamu bisa belajar sejarah di tengah-tengah modernisasi Kota Jakarta.', 'location' => 'Jakarta', 'price' => '400000'
        ]);
        DB::table('packages')->insert([
            'id' => 4, 'code' => 'P004', 'name' => 'Paket Wisata Bromo', 'default_picture' => 'images/paket_bromo.jpg', 'desc' => 'Dunia Fantasi adalah salah satu tempat rekresi yang tepat untuk wahana bermain dan berkumpul bersama keluarga atau teman.', 'location' => 'Malang', 'price' => '500000'
        ]);
        DB::table('packages')->insert([
            'id' => 5, 'code' => 'P005', 'name' => 'Paket Wisata Jogja', 'default_picture' => 'images/paket_jogja.jpg', 'desc' => 'Lembang merupakan objek wisata dimana kamu bisa belajar sejarah di tengah-tengah modernisasi Kota Jakarta.', 'location' => 'Jogjakarta', 'price' => '400000'
        ]);
        DB::table('packages')->insert([
            'id' => 6, 'code' => 'P006', 'name' => 'Paket Wisata Surabaya', 'default_picture' => 'images/paket_surabaya.png', 'desc' => 'Kepulauan seribu merupakan objek wisata dimana kamu bisa belajar sejarah di tengah-tengah modernisasi Kota Jakarta.', 'location' => 'Surabaya', 'price' => '400000'
        ]);
...
=======
        ...
        DB::table('packages')->insert([
            'id' => 3, 'code' => 'P003', 'name' => 'Paket Wisata Kepulauan Seribu', 'desc' => 'Kepulauan seribu merupakan objek wisata dimana kamu bisa belajar sejarah di tengah-tengah modernisasi Kota Jakarta.', 'location' => 'Jakarta', 'price' => '400000', 'default_picture' => 'uploads/wisata/05_jawa_barat/kota_tua.jpg'
        ]);
>>>>>>> 779fb8617195292f90ee91ef04981164560a92e8
    }
}
