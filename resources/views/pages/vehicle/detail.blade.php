...
@section('content')
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">{{ $vehicle->name }}</div>
		</div>
	</div>
						...
						<div class="hotel_info">
							...
							<div class="hotel_title_container d-flex flex-lg-row flex-column">
								<div class="hotel_title_content">
									<h1 class="hotel_title">{{ $vehicle->name }}</h1>
									...
									<div class="hotel_location">{{ $vehicle->location }}</div>
								</div>
								<div class="hotel_title_button ml-lg-auto text-lg-right">
									<div class="button book_button trans_200"><a href="#" onclick="createOrder('{{ $vehicle->id }}', 'vehicle')">book<span></span><span></span><span></span></a></div>
							...
							<div class="hotel_image">
								<img src="{{ asset($vehicle->default_picture) }}" alt="">
