...
<div class="home">
    ...
    <div class="home_content">
        <div class="home_title">Sewa Kendaraan</div>
    </div>
</div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="offers_image_container">
                                    ...
                                    <div class="offer_name"><a href="{{ url('vehicle/'.$vehicle->id) }}">{{ $vehicle->name }}</a></div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="offers_content">
                                    ...
                                    <div class="offers_link"><i class="fa fa-arrow-right"></i> <a href="{{ url('vehicle/'.$vehicle->id) }}">read more</a> &nbsp;&nbsp;&nbsp; <a href="#" onclick="createOrder('{{ $vehicle->id }}', 'vehicle')"> <i class="fa fa-shopping-cart"></i> order now</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
