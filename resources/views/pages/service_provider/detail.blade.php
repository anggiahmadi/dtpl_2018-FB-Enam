...
@section('content')
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">{{ $service_provider->name }}</div>
		</div>
	</div>
						...
						<div class="hotel_info">
							...
							<div class="hotel_title_container d-flex flex-lg-row flex-column">
								<div class="hotel_title_content">
									<h1 class="hotel_title">{{ $service_provider->name }}</h1>
									...
									<div class="hotel_location">{{ $service_provider->location }}</div>
								</div>
								<div class="hotel_title_button ml-lg-auto text-lg-right">
									<div class="button book_button trans_200"><a href="#" onclick="createOrder('{{ $service_provider->id }}', 'service_provider')">book<span></span><span></span><span></span></a></div>
							...
							<div class="hotel_image">
								<img src="{{ asset($service_provider->default_picture) }}" alt="">
							...
							<div class="hotel_gallery">
								<div class="hotel_slider_container">
									<div class="owl-carousel owl-theme hotel_slider">
                                        @foreach($service_provider->photo as $photo)
									...
									@if(sizeof($service_provider->photo) > 0)
