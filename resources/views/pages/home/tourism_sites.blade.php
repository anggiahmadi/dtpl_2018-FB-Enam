    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h2 class="section_title" style="margin-top: 20px; height: 10px;">Daftar Lokasi Wisata</h2>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="offers_image_container">
                                ...
                                <div class="offers_image_background" style="background-image:url({{ $data->default_picture }})"></div>
                                <div class="offer_name" style="width:250px"><a href="#">{{ $data->name }}</a></div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="offers_content">
                                <div class="offers_price">Rp {{ $data->price }}<span>/ orang</span></div>
