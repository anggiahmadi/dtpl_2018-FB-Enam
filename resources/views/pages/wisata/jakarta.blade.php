...
<div class="intro">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="intro_title text-center">Pilih tempat wisata di Jakarta, yuk!</h2>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row intro_items">
            ...
            <div class="col-lg-4 intro_col">
                <div class="intro_item">
                    ...
                    <div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
                        <div class="intro_date">JAKARTA AQUARIUM</div>
                        <div class="button intro_button"><div class="button_bcg"></div><a href="#">see more<span></span><span></span><span></span></a></div>
                        <div class="intro_center text-center">
                            {{-- <h1>Greece</h1> --}}
                            <div class="intro_price">From Rp 140K</div>
                            <div class="rating rating_4">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
            ...
            <div class="col-lg-4 intro_col">
                <div class="intro_item">
                    ...
                    <div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
                        <div class="intro_date">KOTA TUA</div>
                        <div class="button intro_button"><div class="button_bcg"></div><a href="#">see more<span></span><span></span><span></span></a></div>
                        <div class="intro_center text-center">
                            {{-- <h1>Scotland</h1> --}}
                            <div class="intro_price">From Rp 10K</div>
                            <div class="rating rating_4">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
            ...
            <div class="col">
                ...
                <div class="test_slider_container">
                    <div class="owl-carousel owl-theme test_slider">
                        ...
                        <div class="owl-item">
                            <div class="test_item">
                                <div class="test_image"><img src="{{ asset('images/test_1.jpg') }}" alt="https://unsplash.com/@anniegray"></div>
                        ...
                        <div class="owl-item">
                            <div class="test_item">
                                <div class="test_image"><img src="{{ asset('images/test_2.jpg') }}" alt="https://unsplash.com/@tschax"></div>
                                <div class="test_icon"><img src="{{ asset('images/island_t.png') }}" alt=""></div>
                                <div class="test_content_container">
                                    <div class="test_content">
                                        <div class="test_item_info">
                                            <div class="test_name">carla smith</div>
                        ...
                        <div class="owl-item">
                            <div class="test_item">
                                <div class="test_image"><img src="{{ asset('images/test_3.jpg') }}" alt="https://unsplash.com/@seefromthesky"></div>
                                <div class="test_icon"><img src="{{ asset('images/kayak.png') }}" alt=""></div>
                                <div class="test_content_container">
                                    <div class="test_content">
                                        <div class="test_item_info">
                                            <div class="test_name">carla smith</div>
                        ...
                        <div class="owl-item">
                            <div class="test_item">
                                <div class="test_image"><img src="{{ asset('images/test_2.jpg') }}" alt=""></div>
                                <div class="test_icon"><img src="{{ asset('images/island_t.png') }}" alt=""></div>
                                <div class="test_content_container">
                                    <div class="test_content">
                                        <div class="test_item_info">
                        ...
                        <div class="owl-item">
                            <div class="test_item">
                                <div class="test_image"><img src="{{ asset('images/test_1.jpg') }}" alt=""></div>
                                <div class="test_icon"><img src="{{ asset('images/backpack.png') }}" alt=""></div>
                                <div class="test_content_container">
                                    <div class="test_content">
                                        <div class="test_item_info">
                        ...
                        <div class="owl-item">
                            <div class="test_item">
                                <div class="test_image"><img src="{{ asset('images/test_3.jpg') }}" alt=""></div>
                                <div class="test_icon"><img src="{{ asset('images/kayak.png') }}" alt=""></div>
                                <div class="test_content_container">
                                    <div class="test_content">
                                        <div class="test_item_info">
