...
@section('content')
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">{{ $package->name }}</div>
		</div>
	</div>
						...
						<div class="hotel_info">
							...
							<div class="hotel_title_container d-flex flex-lg-row flex-column">
								<div class="hotel_title_content">
									...
									<div class="hotel_location">{{ $package->location }}</div>
								</div>
								<div class="hotel_title_button ml-lg-auto text-lg-right">
									<div class="button book_button trans_200"><a href="#" onclick="createOrder('{{ $package->id }}', 'package')">book<span></span><span></span><span></span></a></div>
							...
							<div class="hotel_image">
								<img src="{{ asset($package->default_picture) }}" alt="">
