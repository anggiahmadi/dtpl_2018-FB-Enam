...
@section('content')
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">{{ $lodgement->name }}</div>
		</div>
	</div>
						...
						<div class="hotel_info">
							...
							<div class="hotel_title_container d-flex flex-lg-row flex-column">
								<div class="hotel_title_content">
									<h1 class="hotel_title">{{ $lodgement->name }}</h1>
									...
									<div class="hotel_location">{{ $lodgement->location }}</div>
								</div>
								<div class="hotel_title_button ml-lg-auto text-lg-right">
									<div class="button book_button trans_200">&nbsp;</div>
							...
							<div class="hotel_image">
								<img src="{{ asset($lodgement->default_picture) }}" alt="">
							...
							<div class="hotel_gallery">
								<div class="hotel_slider_container">
									<div class="owl-carousel owl-theme hotel_slider">
                                        @foreach($lodgement->photo as $photo)
								...
								<div class="row">
									<div class="col-lg-2">
										<div class="room_image">
                                            @if($lodgement_type->default_picture == null)
                                                <img src="{{ asset($lodgement->default_picture) }}" alt="https://unsplash.com/@grovemade">
                                            @else
                                                <img src="{{ asset($lodgement_type->default_picture) }}" alt="https://unsplash.com/@grovemade">
                                            @endif
                                        </div>
									</div>
									<div class="col-lg-7">
										<div class="room_content">
											<div class="room_title">{{ $lodgement_type->name }}</div>
											<div class="room_price">Rp {{ number_format($lodgement_type->price, 0, ',', '.') }}</div>
											<div class="room_text">{{ $lodgement_type->desc }}</div>
